    ...
    <div class="top_controls">
      <div class="oscillator-group">
        ...
        <div class="radio-list">
          <label v-for="type in types" :key="type.value" class="radio-option">
            <input v-model="synthSettings.oscillatorType" type="radio" name="oscillator-type" :value="type.value" />
      ...
      <div class="volume-group">
        ...
        <div class="slider-row">
          <input
            v-model.number="synthSettings.volume"
            class="volume-slider"
            type="range"
            min="-6"
            max="6"
...
.oscillator-panel {
  ...
  margin-bottom: 28px; /* Abstand zum ADSR Panel */
